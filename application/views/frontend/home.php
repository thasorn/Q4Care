...
<body>
  <div class="container-fluid display-table">
    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <?php if (!empty($user['role'])): ?>
        <iframe style="margin-top:5%;margin-left:1%;border:none;height:80vh" src="<?php echo REAL_PATH ?>/Dashboard/manageQue" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <?php else: ?>
        <iframe style="margin-top:5%;margin-left:1%;border:none;height:80vh" src="<?php echo REAL_PATH ?>/Dashboard/queueDetail" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <?php endif; ?>
    </div>
  </div>
</body>
