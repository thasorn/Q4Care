  ...
  <div class="container">
    <div class="row clearfix">
      <div class="col-md-12 table-responsive">
        <center><h2>Your Queue</h2></center></div>
        ...
        <table class="table table-bordered table-hover table-sortable" id="tab_logic">
          <thead>
            ...
            <?php foreach ($detail->result_array() as $row): ?>
              <tbody>
                ...
                <td data-name="doctor">
                  <input disabled type="text" name='name0'  placeholder='Doctor Name' class="form-control"/>
                </td>
              </tr>
            </tbody>
            <?php $counter++; ?>
          <?php endforeach; ?>
        <?php else:?>
          <center><h2>No doctor appointment</h2></center>
        <?php endif; ?>
      </table>
